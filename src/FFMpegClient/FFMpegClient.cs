...
namespace DR.FFMpegClient
{
    ...
    public partial class ClientClient 
    {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<ClientHeartbeat>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
        ...
        public async System.Threading.Tasks.Task<int> PruneInactiveClientsAsync(string maxAge, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (maxAge != null) urlBuilder_.Append("maxAge=").Append(System.Uri.EscapeDataString(ConvertToString(maxAge, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<ServiceStatus>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
    ...
    public partial class JobClient 
    {
        ...
        public async System.Threading.Tasks.Task<bool> DeleteJobAsync(System.Guid jobCorrelationId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("jobCorrelationId=").Append(System.Uri.EscapeDataString(ConvertToString(jobCorrelationId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<FfmpegJobModel>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<FfmpegJobModel>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
    ...
    public partial class SystemStatusClient 
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Check>> GetAllAsync()
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Check>> GetAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            var result_ = default(System.Collections.ObjectModel.ObservableCollection<Check>); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<Check>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                        ...
                        return default(System.Collections.ObjectModel.ObservableCollection<Check>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class TaskClient 
    {
        ...
        public async System.Threading.Tasks.Task<FFmpegTaskDto> GetNextAsync(string machineName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("machineName=").Append(System.Uri.EscapeDataString(ConvertToString(machineName, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<FFmpegTaskDto>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.19.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class DeinterlacingJobRequestModel : System.ComponentModel.INotifyPropertyChanged
    {
        private string _videoSourceFilename;
        private string _destinationFilename;
        private string _outputFolder;
        ...
        public static DeinterlacingJobRequestModel FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeinterlacingJobRequestModel>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.19.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class LoudnessJobRequestModel : System.ComponentModel.INotifyPropertyChanged
    {
        private string _audioPresetFile;
        private string _destinationFilename;
        private System.Collections.ObjectModel.ObservableCollection<string> _sourceFilenames = new System.Collections.ObjectModel.ObservableCollection<string>();
        private string _outputFolder;
        private System.DateTime _needed;
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public string AudioPresetFile
        {
            get { return _audioPresetFile; }
            set 
            {
                if (_audioPresetFile != value)
                {
                    _audioPresetFile = value; 
                    RaisePropertyChanged();
                }
            }
        }
        ...
        public static LoudnessJobRequestModel FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<LoudnessJobRequestModel>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.19.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Check : System.ComponentModel.INotifyPropertyChanged
    {
        private string _name;
        private Description _description;
        private bool? _passed;
        private CheckCurrentLevel? _currentLevel;
        private object _exception;
        private System.Collections.ObjectModel.ObservableCollection<Reaction> _reactions;
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CheckCurrentLevel? CurrentLevel
        {
        ...
        public System.Collections.ObjectModel.ObservableCollection<Reaction> Reactions
        {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.19.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Description : System.ComponentModel.INotifyPropertyChanged
    {
        private string _text;
        private string _link;
        private DescriptionLevel? _level;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.19.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Reaction : System.ComponentModel.INotifyPropertyChanged
    {
        private string _url;
        ...
        {
            get { return _visualDescription; }
            set 
            {
                if (_visualDescription != value)
                {
                    _visualDescription = value; 
                    RaisePropertyChanged();
                }
            }
        }
        ...
        public static Reaction FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Reaction>(data);
        }
