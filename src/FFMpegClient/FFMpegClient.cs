        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<ClientHeartbeat>> GetAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<ClientHeartbeat>>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<ServiceStatus> GetAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<ServiceStatus>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<bool> DeleteJobAsync(System.Guid jobCorrelationId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<bool>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<FfmpegJobModel>> GetAllAsync(int? take, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<FfmpegJobModel>>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<Response> UpdateProgressAsync(TaskProgressModel model, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<Response>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<FfmpegJobModel> GetAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<FfmpegJobModel>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<FFmpegTaskDto> GetNextAsync(string machineName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<FFmpegTaskDto>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
